...
public final class LumenContainerOpener {
    ...
    public static boolean isContainer(ItemStack stack) {
        return LumenContainerContents.isOpenable(stack)
                || previewConfig().enderChest && stack.is(Items.ENDER_CHEST) && LumenEnderChestMemory.isKnown();
    }
    ...
    private static boolean open(ItemStack stack) {
        ...
        var items = config.enderChest && stack.is(Items.ENDER_CHEST) && LumenEnderChestMemory.isKnown()
