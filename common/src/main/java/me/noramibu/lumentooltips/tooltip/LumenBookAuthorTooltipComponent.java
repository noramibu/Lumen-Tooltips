...
public final class LumenBookAuthorTooltipComponent implements Component, FormattedCharSequence, ClientTooltipComponent {
    ...
    private static final Map<String, CompletableFuture<PlayerSkin>> SKINS = new ConcurrentHashMap<>();
